...
// ELLI: on startup load spork values from previous session if they exist in the sporkDB
...
int64_t GetSporkValue(int nSporkID)
{
    ...
    if (mapSporksActive.count(nSporkID)) {
        ...
        if (nSporkID == SPORK_11_MASTERNODE_PAYMENT_ENFORCEMENT_2) r = SPORK_11_MASTERNODE_PAYMENT_ENFORCEMENT_2_DEFAULT;
...
int CSporkManager::GetSporkIDByName(std::string strName)
{
    ...
    if (strName == "SPORK_11_MASTERNODE_PAYMENT_ENFORCEMENT_2") return SPORK_11_MASTERNODE_PAYMENT_ENFORCEMENT_2;
...
std::string CSporkManager::GetSporkNameByID(int id)
{
    ...
    if (id == SPORK_11_MASTERNODE_PAYMENT_ENFORCEMENT_2) return "SPORK_11_MASTERNODE_PAYMENT_ENFORCEMENT_2";
