                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("ELLI Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a ELLI address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and elli: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zELLI"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About ELLI Core"), this);
    aboutAction->setStatusTip(tr("Show information about ELLI Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for ELLI"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your ELLI addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified ELLI addresses"));
    ...
    openAction->setStatusTip(tr("Open a ELLI: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the ELLI Core help message to get a list with possible ELLI command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("ELLI Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to ELLI network", "", count));
}
...
{
    QString strTitle = tr("ELLI Core"); // default title
