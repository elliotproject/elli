...
#   c) node1 mines 32 blocks, so now node 0 has 60001elli, node 1 has 4250elli, node2 has none.
#   d) node0 sends 601 elli to node2, in two transactions (301 elli, then 300 elli).
