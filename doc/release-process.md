...
* Update translations see [translation_process.md](https://github.com/elliotproject/elli/blob/master/doc/translation_process.md#synchronising-translations).
...
### Build and sign ELLI Core for Linux, Windows, and OS X:
    ...
    ./bin/gbuild --memory 3000 --commit elli=v${VERSION} ../elli/contrib/gitian-descriptors/gitian-osx.yml
...
- Detached signatures will then be committed to the [elli-detached-sigs](https://github.com/elliotproject/elli-detached-sigs) repository, which can be combined with the unsigned apps to create signed binaries.
...
space *do not upload these to the elliotproject.org server*.
