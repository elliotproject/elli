...
RESOURCES += src/qt/elli.qrc src/qt/elli_locale.qrc

TRANSLATIONS += src/qt/locale/elli_bg.ts \
                src/qt/locale/elli_de.ts \
                src/qt/locale/elli_en.ts \
                src/qt/locale/elli_es.ts \
                src/qt/locale/elli_fi.ts \
                src/qt/locale/elli_fr.ts \
                src/qt/locale/elli_it.ts \
                src/qt/locale/elli_ja.ts \
                src/qt/locale/elli_pl.ts \
                src/qt/locale/elli_pt.ts \
                src/qt/locale/elli_ru.ts \
                src/qt/locale/elli_sk.ts \
                src/qt/locale/elli_sv.ts \
                src/qt/locale/elli_vi.ts \
                src/qt/locale/elli_zh_CN.ts \
                src/qt/locale/elli_zh_TW.ts
